...
public class SecondViewAdapter extends BaseAdapter
{
	  private LayoutInflater mInflater;	  
	  private LinkedList<ImageInfo> imageInfo;
	  private Context mContext;
	  public SecondViewAdapter(Context context, LinkedList<ImageInfo> imageInfos)
	  {
	  ...
	  public View getView(int position,View convertView,ViewGroup parent)
	  {
	    ...
	    if(convertView == null)
	    {
	      convertView = mInflater.inflate(R.layout.second_model, null);
