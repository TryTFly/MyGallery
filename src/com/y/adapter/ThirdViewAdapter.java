...
public class ThirdViewAdapter extends BaseAdapter
{
	  ...
	  public ThirdViewAdapter(Context context, int f, String name, String[] rows)
	  {
	  ...
	  public View getView(int position,View convertView,ViewGroup parent)
	  {
	      ...
	      if(convertView == null)
	      {
	        convertView = mInflater.inflate(R.layout.third_grid_model, null);  
	      ...
	      if(flag==0)
	      {
	    	  Log.i(TAG, "====code here====");
	    	    try
		        {
			    	...
			    	if(image==null)
			    	{
			    		image=BitmapFactory.decodeResource(c.getResources(), R.drawable.bg);
			    	}
